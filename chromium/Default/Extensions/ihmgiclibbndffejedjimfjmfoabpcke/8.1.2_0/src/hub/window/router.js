    ...
    pl.extend(ke.app, {
        ...
        init: function () {
            ...
            ke.ext.util.storageUtil.chainRequestBackgroundOption([
                ...
                {fn: 'getDecodedVal', args: ['sponsorships']},
                {fn: 'getDecodedVal', args: ['sponsorships_last_claim']}
            ], function (r) {
                var is_gdpr = r[0].response;
                var is_pro = r[4].response;
                var dark_mode = r[8].response;
                
                ke.app.temp.sponsorships = r[11].response;
                ke.app.temp.last_claim_click = r[12].response;
