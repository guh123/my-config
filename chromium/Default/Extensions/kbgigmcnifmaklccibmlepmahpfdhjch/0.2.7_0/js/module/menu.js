...
container.define("oneMenu", ["addon", "menuSettings", "router", "similar", "downloader"], function (addon, menuSettings, router, similar, downloader) {
    var obj = {
        items: {}
    };
    ...
    obj.handleMenuQrcodeEvent = function (item, info, tab) {
        ...
        router.openOneTab("tool-qrcode", "/one/tool/qrcode.html?text=" + encodeURIComponent(link), true);
    };
