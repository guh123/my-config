...
container.define("oneProxy", ["addon", "manifest", "http", "notify", "proxy", "proxyMatch", "proxyPac", "proxyAuth", "proxyRule", "factory"], function (addon, manifest, http, notify, proxy, proxyMatch, proxyPac, proxyAuth, proxyRule, factory) {
    var obj = {
        timer: null,
        modes: {
    ...
    obj.preTestProxy = function () {
        ...
        var testUrlList = manifest.getItem("proxy_test_url_list");
